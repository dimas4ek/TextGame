...
namespace TEXT_GAME
{
    class Program
    {
        ...
        public static void LoadSave()
        {
            ...
            if(whatSave == 1)
            {
                string path = "Game/acts/act1_2.txt";
            ...
            {
                string path = "Game/acts/act2_2.txt";
                reader = new StreamReader(path);
                Action(reader.ReadLine());
                Pause(); 
                Console.Clear();
            ...
            {
                string path = "Game/acts/act3_2.txt";
                reader = new StreamReader(path);
                Action(reader.ReadLine());
                Pause(); 
                Console.Clear();
            ...
            {
                string path = "Game/acts/act4_2.txt";
                reader = new StreamReader(path);
                Action(reader.ReadToEnd());
                Pause();
                Console.Clear();
